...
public class RedstoneLinkNetworkHandler {
    ...
    static final Map<IWorld, Map<Pair<String, String>, Set<IRedstoneLinkable>>> connections = new IdentityHashMap<>();
    ...
    public static class Frequency {
        ...
        @Override
        public int hashCode() {
            return (itemName.hashCode() * 31) ^ color;
        }
        ...
        public boolean equals(Object obj) {
            if (this == obj)
                return true;
            return obj instanceof Frequency && ((Frequency) obj).itemName.equals(itemName)
                    && ((Frequency) obj).color == color;
        }
    ...
    public Set<IRedstoneLinkable> getNetworkOf(IWorld world, IRedstoneLinkable actor) {
        Map<Pair<String, String>, Set<IRedstoneLinkable>> networksInWorld = networksIn(world);
        Pair<String, String> key = actor.getNetworkKey();
    ...
    public Map<Pair<String, String>, Set<IRedstoneLinkable>> networksIn(IWorld world) {
